                                ...
                                <div class="u_header_ctr">
                                    ...
                                    <div class="u_header_profile_content_ctr">
                                        ...
                                        <div class="u_header_profile_content_name_ctr">
                                            <h1 class="u_header_profile_content_name">Hej <?php if(isset($_SESSION['user_firstname'])){echo $_SESSION['user_firstname'];}else{echo "";} ?></h1>
                                        </div>
                                        <div class="u_header_profile_content_links_ctr">
                                            <div class="u_header_profile_content_link_settings_ctr">
                                                <a href="./u_settings.php" class="u_header_profile_content_link">Inställningar <i class="fas fa-user-cog"></i></a>
                                            </div>
                                            <div class="u_header_profile_content_link_faq_ctr">
                                                <a href="./faq.php" class="u_header_profile_content_link">FAQ <i class="fas fa-question-circle"></i></a>
                                            </div>
