...
if ($sqlQueryRows > 0) {
    while ($sqlRow = mysqli_fetch_assoc($sqlQuery)) {
        ...
        // REFER POINT 1
        echo '<div class="u_grade_box"><div class="u_grade_hold_ctr" data-grade-id="'.$sqlCourseUniqueId.'"><div class="u_grade_name_ctr"><p class="u_grade_parg" data-grade-name-id="'.$sqlCourseUniqueId.'">'.$sqlCourseName.'</p></div><div class="u_grade_grade_ctr"><p class="u_grade_parg" data-grade-letter-id="'.$sqlCourseUniqueId.'">'.$sqlCourseGrade.'</p></div><div class="u_grade_value_ctr"><p class="u_grade_parg" data-grade-value-id="'.$sqlCourseUniqueId.'">'.$sqlCourseValue.'</p></div></div><div class="u_grade_manage_ctr" id="'.$sqlCourseUniqueId.'"><div class="u_manage_content_ctr"><div class="u_manage_edit_ctr"><i class="far fa-edit u_manage_edit" data-grade-btn-id="'.$sqlCourseUniqueId.'"></i></div><div class="u_manage_delete_ctr"><i class="fas fa-trash-alt u_manage_delete" data-delete-id="'.$sqlCourseDeleteId.'"></i></div><div class="u_manage_delete_form_ctr" id="'.$sqlCourseDeleteId.'"><div class="u_manage_delete_form_box"><form action="./assets/php/actions/act_u_delete.php" method="post" class="u_manage_delete_form"><input type="text" style="display: none" name="delete_id" value="'.$sqlCourseDeleteId.'"><div class="u_manage_delete_form_message_ctr"><p class="u_manage_delete_form_message">Är du säker?</p></div><div class="u_manage_delete_form_btn_ctr"><button type="submit" class="u_manage_delete_form_btn" name="delete_submit">Ja</button></div></form></div></div></div></div></div>';
    }
}
...
// echo            '<p class="u_grade_parg" data-grade-value-id="">'.$sqlCourseValue.'</p>';
// echo        '</div>';
// echo    '</div>';
...
// echo                        '<input type="text" style="display: none" name="delete_id" value="'.$sqlCourseDeleteId.'">';
